...
class SecureSessionStore(context: Context) {
    private val prefs = context.getSharedPreferences("luma_secure_session", Context.MODE_PRIVATE)
    private val keyAlias = "luma_emby_token"
    ...
    fun load(): EmbySession? = runCatching {
        ...
        val token = Base64.decode(prefs.getString("token", null), Base64.NO_WRAP)
